...
show_menu(){
    ...
    /bin/echo -e "\e[1;49;93m    6   Oh My ZSH and other recemnded Pkgs Installation \e[0m"
...
help_me(){
    ...
    /bin/echo -e "\e[1;49;91m    6   Oh My ZSH and other recemnded Pkgs Installation:  \e[0m"
